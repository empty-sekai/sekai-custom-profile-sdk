...
impl CustomProfileRenderer {
    ...
    fn ensure_profile_fallback_for_scenes<'a>(
        ...
        scenes: impl IntoIterator<
            Item = &'a sekai_profile_renderer_core::profile_scene::ResolvedProfileScene,
        >,
        md: &MasterData,
    ) -> Result<Option<crate::sdf::fallback_cache::PersistentFallbackSdfCacheReport>, String> {
        use sekai_profile_renderer_core::{FontRole, SemanticCommandPayload, TextSource};
    ...
    pub fn dump_text_scene(
        ...
        document_key: &str,
        tick: u64,
    ) -> Result<sekai_profile_renderer_core::SceneDump, String> {
        let started = std::time::Instant::now();
        let md = self.snapshot();
...
fn render_authored_image_into_pixels(
    ...
    md: &MasterData,
    assets: Option<&AssetStore>,
    authored_kind: sekai_profile_renderer_core::AuthoredElementKind,
    authored_index: u32,
    width: u32,
    height: u32,
    canvas_origin_x: f32,
...
) -> Option<(sekai_profile_renderer_core::AuthoredElementKind, u32)> {
...
impl CustomProfileRenderer {
    ...
    pub fn animation_preflight_with_profile(
        ...
        region: &str,
        maximum_tick: u64,
    ) -> Result<sekai_profile_renderer_core::AnimationPreflight, String> {
        let md = self.snapshot();
