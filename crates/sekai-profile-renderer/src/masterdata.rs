...
impl ResolvedHonor {
    ...
    pub fn effective_background_asset_bundle_name(&self) -> &str {
        sekai_profile_renderer_core::masterdata::effective_honor_background_asset_bundle_name(
            &self.honor_type,
    ...
    pub fn has_rank_overlay(&self) -> bool {
        sekai_profile_renderer_core::masterdata::honor_has_rank_overlay(
            &self.honor_type,
            &self.asset_bundle_name,
            self.is_live_master,
        )
...
pub trait MasterDataProvider: Send + Sync {
    ...
    /// provider 覆盖（直接查原始 JSON 表的 `name` 字段）。
...
impl sekai_profile_renderer_core::masterdata::ProfileMasterData for MasterData {
    ...
    fn get_card(&self, card_id: i32) -> Option<sekai_profile_renderer_core::masterdata::CardEntry> {
        MasterData::get_card(self, card_id).map(|value| {
            sekai_profile_renderer_core::masterdata::CardEntry {
                id: value.id,
    ...
    fn resolve_resource(
        ...
        resource_type: &str,
        id: i32,
    ) -> Option<sekai_profile_renderer_core::masterdata::ResourceInfo> {
        MasterData::resolve_resource(self, resource_type, id).map(|value| {
            sekai_profile_renderer_core::masterdata::ResourceInfo {
    ...
    fn get_bonds_honor(
        &self,
        id: i32,
    ) -> Option<sekai_profile_renderer_core::masterdata::BondsHonorEntry> {
        MasterData::get_bonds_honor(self, id).map(|value| {
            sekai_profile_renderer_core::masterdata::BondsHonorEntry {
                id: value.id,
    ...
    fn get_bonds_honor_word(
        &self,
        id: i64,
    ) -> Option<sekai_profile_renderer_core::masterdata::BondsHonorWordEntry> {
        MasterData::get_bonds_honor_word(self, id).map(|value| {
            sekai_profile_renderer_core::masterdata::BondsHonorWordEntry {
